...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            @auth
            <a class="btn-getstarted" href="{{ route('dashboard') }}">Dahsboard</a>
    ...
    <main class="main">
        ...
        <section id="about" class="about section">
            ...
            <div class="container section-title" data-aos="fade-up">
                ...
                <h2>About</h2>
                <p>Aplikasi ini memudahkan kita untuk mengelola tugas </p>
    ...
    <footer id="footer" class="footer">
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">JIDAN</strong> <span>All Rights Reserved</span>
            </p>
            <div class="credits">
